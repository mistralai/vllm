...
if TYPE_CHECKING:
    ...
    VLLM_HISPARSE_DISABLE_PREFETCH: bool = False
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Diagnostic: run HiSparse follower gathers on the compute stream instead
    # of the prefetch side stream (A/B for CUDA-graph capture interactions).
    "VLLM_HISPARSE_DISABLE_PREFETCH": lambda: (
        os.environ.get("VLLM_HISPARSE_DISABLE_PREFETCH", "0") == "1"
    ),
